...
const Sidebar = ({ activePage, onLogout, onNavigate, isMobileOpen, toggleSidebar }) => {
  ...
  const handleMenuItemClick = (itemId) => {
    if (onNavigate) {
      onNavigate(itemId);
      // بستن sidebar بعد از کلیک در نمای موبایل (اگر تابع toggleSidebar ارسال شده باشد)
  ...
  const isSettingActive = isSettingSubActive; // فقط زمانی که زیرمنو فعال است، Setting فعال می‌شود


  return (
    <div className={`sidebar-container ${isMobileOpen ? 'open' : ''}`}>
      
      {/* Overlay برای بستن Sidebar در موبایل */}
      {isMobileOpen && <div className="sidebar-overlay" onClick={toggleSidebar}></div>}

      <div className="sidebar">
          
           {/* دکمه بستن در بالای Sidebar موبایل/تبلت */}
          ...
          <nav className="sidebar-menu">
            ...
            {mainMenuItems.map(item => (
              ...
              >
                {/* دایره رنگی فعال در پس‌زمینه (فقط برای آیتم اصلی) */}
            ...
            <div className="settings-section">
              ...
              >
                {/* div.menu-item برای گرفتن استایل‌های مشترک و افکت فعال */}
                <div className={`menu-item ${isSettingActive ? 'active' : ''}`}>
                   {/* دایره رنگی فعال در پس‌زمینه برای Setting */}
