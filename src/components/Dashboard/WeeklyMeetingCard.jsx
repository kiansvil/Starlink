// WeeklyMeetingCard.jsx - کد نهایی اصلاح شده با SVG پس‌زمینه
import React from 'react';
import './MeetingCard.css';

// =======================================================
// ✅ SVG شکل بلیط برای پس‌زمینه
// =======================================================
const WeeklyTicketShape = (props) => (
    ...
    >
        ...
        />
        <defs>
            {/* ID گرادیانت را تغییر دادم تا با IDهای احتمالی دیگر در صفحه تداخل نکند */}
...
const WeeklyMeetingCard = ({ meeting }) => {
  ...
  return (
    <div className="weekly-card">
      ...
      {/* ⬅️ SVG پس‌زمینه (باید اولین عنصر باشد) */}
      <div className="weekly-card-svg-wrapper">
        <WeeklyTicketShape />
      </div>
        
      {/* تگ Meeting N (سمت چپ) - Z-index بالا برای دیده شدن روی SVG */}
      <div className="meeting-number-tag left-tag">
        MEETING {meeting.meetingNumber}
      </div>

      {/* بخش اصلی محتوای کارت - Z-index بالا برای دیده شدن روی SVG */}
      <div className="weekly-card-main-wrapper">
        
        {/* اطلاعات نام و نقش (بالای محتوای اصلی) */}
      ...
      {/* تگ Meeting N (سمت راست) - Z-index بالا */}
