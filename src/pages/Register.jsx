    ...
    <AuthLayout>
      <div className="auth-form-container">
        <div className="auth-header">
          <h2>Welcome to <span className="brand-accent">STAR LINK</span></h2>
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-options">
            <label className="checkbox-container">
              ...
              I agree to the <a href="#!" className="terms-link">Terms and</a> <a href="#!" className="terms-link">conditions</a>
            </label>
          </div>
